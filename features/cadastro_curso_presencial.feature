...
Funcionalidade: Cadastro de Curso
  ...
  Cenário: CT-001 (Sucesso) Cadastrar um curso presencial com sucesso (Caminho Feliz)
    Dado que eu estou na página de "Cadastro de curso"
    Quando eu preencher o formulário com dados válidos para um curso "Presencial"
    E eu clicar em "Cadastrar Curso"
    Então eu devo ser redirecionado para a "Lista de cursos"
    E eu devo ver o curso "Curso de Automação BDD (Presencial)" na lista
